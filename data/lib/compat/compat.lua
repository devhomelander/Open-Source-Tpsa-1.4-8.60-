...
Combat.setCondition = function(...)
	print(os.time() .. " " .. "[Warning] Function Combat.setCondition was renamed to Combat.addCondition and will be removed in the future")
	Combat.addCondition(...)
end

setCombatCondition = function(...)
	print(os.time() .. " " .. "[Warning] Function setCombatCondition was renamed to addCombatCondition and will be removed in the future")
	Combat.addCondition(...)
end
...
function broadcastMessage(message, messageType)
	...
	print(os.time() .. " " .."> Broadcasted message: \"" .. message .. "\".")
end
