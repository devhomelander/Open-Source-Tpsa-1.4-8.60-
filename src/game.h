...
class Game
{
	public:
		...
		static void internalGetPosition(Item* item, Position& pos, uint16_t& stackpos);
		...
		void playerMoveThing(uint32_t playerId, const Position& fromPos, uint16_t spriteId, uint16_t fromStackPos,
		...
		void playerMoveItemByPlayerID(uint32_t playerId, const Position& fromPos, uint16_t spriteId, uint16_t fromStackPos, const Position& toPos, uint16_t count);
		...
		void playerUseItemEx(uint32_t playerId, const Position& fromPos, uint16_t fromStackPos,
		                     uint16_t fromSpriteId, const Position& toPos, uint16_t toStackPos, uint16_t toSpriteId);
		void playerUseItem(uint32_t playerId, const Position& pos, uint16_t stackPos, uint16_t index, uint16_t spriteId);
